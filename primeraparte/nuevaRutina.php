...
if ($_POST) {
    ...
    echo "<script>window.location='rutinas.php?res=creada';</script>"; exit;
}
  ...
  <div class="container-xl mt-4">
    ...
    <form method="POST" class="card" style="max-width:860px; margin:0 auto;">
      <div class="card-header" style="background:linear-gradient(135deg,#4A148C,#7B1FA2);">
        <span class="card-title" style="color:#fff;"><i class="ti ti-playlist-add me-2"></i>Nueva Rutina de Entrenamiento</span>
      </div>
      <div class="card-body">
          ...
          <table style="width:100%; border-collapse:collapse;" id="tabla-ejercicios">
            <thead>
              <tr style="background:#F9FAFB; border-bottom:2px solid var(--border);">
                <th style="padding:10px 12px; font-size:0.78rem; font-weight:600; color:var(--muted); text-transform:uppercase; letter-spacing:1px; text-align:left;">#</th>
                <th style="padding:10px 12px; font-size:0.78rem; font-weight:600; color:var(--muted); text-transform:uppercase; letter-spacing:1px; text-align:left;">Ejercicio</th>
                <th style="padding:10px 12px; font-size:0.78rem; font-weight:600; color:var(--muted); text-transform:uppercase; letter-spacing:1px; width:90px;">Series</th>
                <th style="padding:10px 12px; font-size:0.78rem; font-weight:600; color:var(--muted); text-transform:uppercase; letter-spacing:1px; width:90px;">Reps</th>
