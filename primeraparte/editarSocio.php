          ...
          <div style="grid-column:1/-1;">
            ...
            <?php if (!empty($socio['foto'])) { ?>
              <div class="mb-2">
                ...
                <img src="<?php echo htmlspecialchars($socio['foto']); ?>" style="width:60px; height:60px; border-radius:50%; object-fit:cover;">
              </div>
            <?php
}?>
            <!-- Campo simple de "Busque en su disco (su PC)" -->
            <input type="file" name="foto" class="form-control" accept="image/*">
            <small class="text-muted">Si no deseas cambiar ni alterar la foto base de manera accidental, por favor simplemente ignora sin teclear esto y déjalo intacto o ignorado.</small>
          </div>
        </div>
