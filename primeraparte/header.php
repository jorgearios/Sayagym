...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .nav-item-drop.show .dropdown-menu {
            display: block;
        }
    ...
    <nav class="gym-navbar">
        <div class="inner">
            ...
            <ul class="gym-nav">
                ...
                /**
                 * Archivo: header.php
                 * Descripción: Cabecera global del sistema (barra de navegación, estilos CSS de Tabler).
                ...
                if (esAdministrador()): ?>
                    ...
                    <li class="nav-item-drop">
                        ...
                        <div class="dropdown-menu">
                            <a href="pos.php"><i class="ti ti-cash"></i> Punto de Venta</a>
                            <a href="inventario.php"><i class="ti ti-package"></i> Inventario</a>
                            <a href="ventas.php"><i class="ti ti-list"></i> Historial Ventas</a>
                            <a href="promociones.php"><i class="ti ti-tag"></i> Promociones</a>
                        </div>
                    </li>
