<?php
// Cargar auth si config.php aún no lo hizo (protección doble)
...
if (!is_dir(__DIR__ . '/imagenes')) {
    mkdir(__DIR__ . '/imagenes', 0755, true);
}
?>
<!doctype html>
<html lang="es">
...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .card-header.blue {
            background: linear-gradient(135deg, #1e3a8a, var(--blue-light));
        }
        ...
        table.gym-table tbody tr:hover {
            background: #F9FAFB;
        }
...
<body>
                ...
                <?php if (esAdministrador()): ?>
                    <li class="nav-item-drop">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="gestionMembresias.php"><i class="ti ti-credit-card"></i> Planes de Membresía</a>
                            <a href="membresias.php"><i class="ti ti-calendar-event"></i> Estado Membresías</a>
                            <a href="acceso.php"><i class="ti ti-door-enter"></i> Control de Acceso</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item-drop">
                        ...
                        <div class="dropdown-menu">
                            <a href="rutinas.php"><i class="ti ti-list-check"></i> Rutinas</a>
                            <a href="ejercicios.php"><i class="ti ti-barbell"></i> Ejercicios</a>
                            <a href="evaluaciones.php"><i class="ti ti-ruler-measure"></i> Evaluaciones Físicas</a>
                            <a href="nutricionAdmin.php"><i class="ti ti-salad"></i> Monitor Nutricional</a>
                            <a href="gestionAlimentos.php"><i class="ti ti-database"></i> Catálogo Alimentos</a>
                        </div>
                    </li>
            ...
            <ul style="list-style:none; margin:0; padding:0;">
                <li class="nav-item-drop">
                    <div class="gym-user-badge">
                        ...
                        <span class="user-name"><?php echo htmlspecialchars($_SESSION['nombre'] ?? 'Usuario'); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            document.querySelectorAll('.has-drop, .gym-user-badge').forEach(function (el) {
