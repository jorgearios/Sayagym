  ...
  <div class="container-xl mt-4">
    ...
    <div class="card">
      <div class="card-header gray">
        <h3 class="card-title">Listado de Rutinas</h3>
      </div>
          ...
          <tbody>
            ...
            while ($r = $rutinas->fetch_assoc()):
              ...
              <tr>
                <td>
                  ...
                  <?php if ($r['descripcion']): ?>
                    <div class="td-muted small">
                      <?php echo htmlspecialchars(substr($r['descripcion'], 0, 55)) . (strlen($r['descripcion']) > 55 ? '...' : ''); ?>
                    </div>
                  <?php endif; ?>
                </td>
                <td><span class="badge <?php echo $badge; ?>"><?php echo htmlspecialchars($r['nivel'] ?? '—'); ?></span>
                </td>
                ...
                <td>
                  <div class="btn-list">
                    <a href="asignarRutina.php?id_rutina=<?php echo $r['id_rutina']; ?>" class="btn btn-icon"
                      title="Asignar a socios" style="color:var(--green);">
