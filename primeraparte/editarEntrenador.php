  ...
  <div class="container-xl mt-4">
    ...
    <form method="POST" class="card" style="max-width:760px; margin:0 auto;">
      ...
      <div class="card-body">
        ...
        <div style="display:grid; grid-template-columns:1fr 1fr; gap:16px;">
          ...
          <div>
            ...
            <input type="text" name="nombre" class="form-control" value="<?php echo htmlspecialchars($e['nombre']); ?>"
              required>
          </div>
          ...
          <div>
            ...
            <input type="text" name="especialidad" class="form-control"
              value="<?php echo htmlspecialchars($e['especialidad']); ?>">
          </div>

          <div>
            <label class="form-label">El Teléfono Actual</label>
            <input type="text" name="telefono" class="form-control"
              value="<?php echo htmlspecialchars($e['telefono']); ?>">
          </div>

          <div>
            <label class="form-label">Correo Electrónico Oficial</label>
            <input type="email" name="correo" class="form-control"
              value="<?php echo htmlspecialchars($e['correo']); ?>">
          </div>
          ...
          <div>
            ...
            <select name="turno" class="form-select">
              ...
              <option value="Matutino" <?php if ($e['turno'] == 'Matutino')
                echo 'selected'; ?>>Matutino Corto</option>
              <option value="Vespertino" <?php if ($e['turno'] == 'Vespertino')
                echo 'selected'; ?>>Vespertino Tarde
              </option>
              <option value="Completo" <?php if ($e['turno'] == 'Completo')
                echo 'selected'; ?>>Completo Intersemanal
              </option>
            </select>
          </div>
          ...
          <div>
            ...
            <input type="number" step="0.01" name="tarifa_comision" class="form-control"
              value="<?php echo $e['tarifa_comision']; ?>">
          </div>
          ...
          <div style="grid-column:1/-1;">
            ...
            <select name="estado" class="form-select">
              <option value="activo" <?php if ($e['estado'] == 'activo')
                echo 'selected'; ?>>Completamente Activo (En
                nómina laboral / Contratado temporal general)</option>
              <option value="inactivo" <?php if ($e['estado'] == 'inactivo')
      ...
      <div class="card-footer">
        ...
        <button type="submit" class="btn btn-red"><i class="ti ti-device-floppy me-1"></i>Actualizar Perfil Existente
          Integrado</button>
      </div>
    </form>
