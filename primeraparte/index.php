      ...
      <div class="card">
        <div class="card-header gray">
          <span class="card-title" style="display:flex; align-items:center; gap:8px;">
            <span
              style="background:var(--danger-lt); color:var(--danger); padding:3px 9px; border-radius:999px; font-size:0.72rem; font-weight:700;">ALERTA</span>
        ...
        if (count($personas_por_vencer) === 0) {
          ...
          <div style="padding:44px 24px; text-align:center;">
            <i class="ti ti-circle-check"
              style="font-size:2.5rem; color:var(--green); display:block; margin-bottom:10px;"></i>
