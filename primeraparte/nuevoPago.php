        ...
        <form action="nuevoPago.php" method="POST">
          ...
          <div class="mb-3">
            ...
            <select name="id_membresia" class="form-select" required>
              ...
              <?php while ($m = $membresias->fetch_assoc()): ?>
                <option value="<?php echo $m['id_membresia']; ?>"><?php echo $m['nombre']; ?>
                  ($<?php echo number_format($m['precio'], 2); ?>)</option>
              <?php endwhile; ?>
            </select>
          </div>
          ...
          <div class="mb-4">
            ...
            <input type="text" name="referencia" class="form-control"
              placeholder="Ej. Número de ticket o terminación de tarjeta">
          </div>

          <button type="submit" class="btn btn-green w-100"
            style="background:var(--green); color:white; justify-content:center;">
