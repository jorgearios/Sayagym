...
$ingresos_mes = $consulta_ingresos->fetch_assoc()['total'] ?? 0;
    ...
    <div class="row mb-4">
      <div class="col-md-4">
        <div class="card" style="border-left: 4px solid var(--green);">
          <div class="card-body">
            <div style="color:var(--muted); font-size:0.8rem; font-weight:600; text-transform:uppercase; margin-bottom:5px;">Ingresos este mes</div>
        ...
        <table class="gym-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="badge <?php echo $color_estado; ?>"><?php echo strtoupper($pago['estado']); ?></span></td>
            </tr>
            <?php endwhile; ?>
            <?php if ($consulta_pagos->num_rows == 0): ?>
            <tr>
                <td colspan="7" style="text-align:center; padding:20px; color:var(--muted);">No hay pagos registrados aún en el sistema.</td>
            </tr>
            <?php endif; ?>
          </tbody>
        </table>
