...
<div class="page-wrapper">
  <div class="container-xl mt-4">
    ...
    <div class="card" style="margin-bottom:20px; padding:16px 20px;">
      <form method="GET" style="display:flex; align-items:center; gap:12px;">
        ...
        <select name="id_socio" class="form-select" style="max-width:280px;" onchange="this.form.submit()">
          ...
          <option value="<?php echo $s['id_socio']; ?>" <?php if($filtro_socio==$s['id_socio']) echo 'selected'; ?>>
    ...
    <div class="card" style="margin-bottom:20px; padding:20px;">
      <div style="font-family:'Oswald',sans-serif; font-size:1rem; font-weight:600; color:var(--text); margin-bottom:16px;">
        ...
        <table class="gym-table">
          ...
          <tbody>
            ...
            <tr><td colspan="9" style="text-align:center; padding:40px; color:var(--muted);">
              Sin evaluaciones registradas. <a href="nuevaEvaluacion.php" style="color:var(--red);">Agrega la primera</a>.
            </td></tr>
            <?php endif; ?>
            <?php while ($ev = $evaluaciones->fetch_assoc()):
              $imc = (float)$ev['imc'];
              if      ($imc < 18.5) { $imc_txt = 'Bajo peso';    $imc_col = 'badge-gold'; }
              elseif  ($imc < 25)   { $imc_txt = 'Normal';       $imc_col = 'badge-green'; }
              elseif  ($imc < 30)   { $imc_txt = 'Sobrepeso';    $imc_col = 'badge-gold'; }
              else                  { $imc_txt = 'Obesidad';      $imc_col = 'badge-red'; }
            ?>
            <tr>
              ...
              <td>
                ...
                <span class="badge <?php echo $imc_col; ?>" style="margin-left:4px; font-size:0.68rem;"><?php echo $imc_txt; ?></span>
                <?php else: ?>—<?php endif; ?>
              </td>
...
echo "<script>window.location='$back';</script>"; exit;
?>
<?php endif; ?>
