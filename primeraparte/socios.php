  ...
  <div class="container-xl mt-4">
    ...
    <div class="row align-items-center mb-4">
      ...
      <div class="col-auto">
        ...
        <a href="/Sayagym/primeraparte/nuevo_socio.php" class="btn btn-red">
    ...
    echo " &middot; " . htmlspecialchars($row['correo']);
              ...
              <td>
                <div class="btn-list">
                  ...
                  <a href="/Sayagym/primeraparte/editar_socio.php?id=<?php echo $row['id_socio']; ?>" class="btn btn-icon edit" title="Editar este registro">
                    <i class="ti ti-edit"></i>
                  </a>
                  
                  <!-- Botón Eliminar que igual manda el ID por la URL, pero antes lanza una ventana emergente ("confirm") de JavaScript -->
                  <a href="/Sayagym/primeraparte/eliminar_socio.php?id=<?php echo $row['id_socio']; ?>" 
