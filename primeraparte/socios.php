...
// JOIN nos permite traer datos de otras tablas usando IDs en común
            ...
            // Recorremos los resultados usando un ciclo "while"
            if ($res && $res->num_rows > 0) {
                ...
                <tr>
                  ...
                  <td>
                    <div style="display:flex; align-items:center; gap:12px;">
                      ...
                      <?php if (!empty($row['foto'])) { ?>
                        ...
                        <div
                          style="width:40px;height:40px;border-radius:50%;background:#F3F4F6;display:flex;align-items:center;justify-content:center;color:#9CA3AF;">
                  ...
                  <td>
                    <div class="btn-list">
                      ...
                      <a href="editarSocio.php?id=<?php echo $row['id_socio']; ?>" class="btn btn-icon edit"
                        title="Editar este registro">
                        <i class="ti ti-edit"></i>
                      </a>

                      <!-- Botón Eliminar que igual manda el ID por la URL, pero antes lanza una ventana emergente ("confirm") de JavaScript -->
                      <a href="eliminarSocio.php?id=<?php echo $row['id_socio']; ?>" class="btn btn-icon"
              ...
              echo '<tr><td colspan="6" class="text-center text-muted" style="padding:20px;">No se encontraron socios registrados.</td></tr>';
            }
            ?>
          </tbody>
        </table>
