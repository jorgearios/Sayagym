...
if (isset($_GET['eliminar'])) {
    ...
    if ($check > 0) {
        ...
        echo "<script>window.location='gestionMembresias.php?res=eliminado';</script>"; exit;
    }
}
...
if (isset($_GET['toggle'])) {
    ...
    echo "<script>window.location='gestionMembresias.php?res=actualizado';</script>"; exit;
}
...
if ($_POST) {
    ...
    if (!empty($_POST['id_membresia'])) {
        ...
        echo "<script>window.location='gestionMembresias.php?res=creado';</script>"; exit;
    }
}
          ...
          <table class="gym-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-list">
                    <a href="gestionMembresias.php?editar=<?php echo $p['id_membresia']; ?>" class="btn btn-icon edit" title="Editar">
                      <i class="ti ti-edit"></i>
                    </a>
                    <a href="gestionMembresias.php?toggle=<?php echo $p['id_membresia']; ?>" class="btn btn-icon" title="<?php echo $p['estado']==='activo'?'Desactivar':'Activar'; ?>">
                      <i class="ti ti-<?php echo $p['estado']==='activo'?'eye-off':'eye'; ?>"></i>
                    </a>
                    <a href="gestionMembresias.php?eliminar=<?php echo $p['id_membresia']; ?>" class="btn btn-icon" title="Eliminar"
                       onclick="return confirm('¿Eliminar este plan permanentemente?');">
